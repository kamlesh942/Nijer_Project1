...
function ProductDeliveryCard() {
  ...
  const [product] = useState({
    image:
      "https://1.bp.blogspot.com/-d0HUbOeVFks/XZMyd4ezuQI/AAAAAAAAMGA/UNx9-QfLxFYU8ks3ziE-tJDg6TaXKp2rwCLcBGAsYHQ/s1600/boat%2Bneck%2Bblouse%2B%252817%2529.jpg",
      ...
      >
        ...
        <div style={{ fontSize: "14px", color: "#333", marginLeft: "10%" }}>
          <p style={{ margin: "0", fontWeight: "bold" }}>
            Delivery on {product.deliveryDate}
          </p>
